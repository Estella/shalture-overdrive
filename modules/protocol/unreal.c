...
DECLARE_MODULE_V1("protocol/unreal", true, _modinit, NULL, PACKAGE_STRING, "Shaltúre developers <https://github.com/shalture>");
...
static unsigned int unreal_server_login(void)
{
	...
	sts("PROTOCTL EAUTH=%s SID=%s", me.name, me.numeric);
